...
import { transitionFromIntentPanelToDirectChannels } from "@/features/contact-screen/lib/transition-from-intent-panel-to-direct-channels/transitionFromIntentPanelToDirectChannels";
